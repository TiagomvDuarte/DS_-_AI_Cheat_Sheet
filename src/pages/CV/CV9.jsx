...
const AnchorDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 480 130" style={{ maxWidth: '100%', height: 'auto' }}>
      {/* Image grid */}
      <rect x={5} y={15} width={130} height={110} rx="4" fill="rgba(74,158,237,0.06)" stroke="#4a9eed" strokeWidth="1"/>
      {/* Grid lines */}
      ...
      {/* Cell com anchors */}
      <rect x={48} y={57} width={43} height={42} rx="2" fill="rgba(74,158,237,0.20)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="69" y="54" textAnchor="middle" fill="#4a9eed" fontSize="6.5">célula (i,j)</text>

      {/* Anchors em destaque */}
      <rect x={52} y={61} width={14} height={14} rx="1" fill="none" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="2,1"/>
      <rect x={56} y={59} width={20} height={34} rx="1" fill="none" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="2,1"/>
      <rect x={50} y={63} width={38} height={24} rx="1" fill="none" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="2,1"/>

      <text x="70" y="136" fill="#4a9eed" fontSize="6.5"> square</text>
      <text x="100" y="136" fill="#4a9eed" fontSize="6.5"> tall</text>
      <text x="125" y="136" fill="#4a9eed" fontSize="6.5"> wide</text>

      {/* Arrow */}
      <line x1="148" y1="70" x2="175" y2="70" stroke="#4a9eed" strokeWidth="1.5"/>
      <polygon points="175,66 183,70 175,74" fill="#4a9eed"/>

      {/* Per anchor predictions */}
      <rect x="185" y="20" width="120" height="100" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="245" y="36" textAnchor="middle" fill="#4a9eed" fontSize="8" fontWeight="700">Por anchor:</text>
      {[
        { y: 50, label: 'objectness score', color: '#4a9eed' },
        { y: 65, label: 'Δx, Δy (offset centro)', color: '#4a9eed' },
        { y: 80, label: 'Δw, Δh (escala box)', color: '#4a9eed' },
        { y: 95, label: 'class probs (K classes)', color: '#4a9eed' },
      ].map(({ y, label, color }) => (
        <g key={y}>
      ...
      {/* Arrow */}
      <line x1="318" y1="70" x2="345" y2="70" stroke="#4a9eed" strokeWidth="1.5"/>
      <polygon points="345,66 353,70 345,74" fill="#4a9eed"/>

      {/* NMS */}
      <rect x="355" y="30" width="115" height="80" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="412" y="48" textAnchor="middle" fill="#4a9eed" fontSize="8" fontWeight="700">NMS</text>
      ...
      <text x="412" y="106" textAnchor="middle" fill="#4a9eed" fontSize="7.5" fontWeight="700">→ detecções finais</text>
    </svg>
  </div>
);
...
const AnchorFreeDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 480 175" style={{ maxWidth: '100%', height: 'auto' }}>
      {/* Anchor-based panel */}
      <rect x={10} y={15} width={210} height={150} rx="6" fill="rgba(74,158,237,0.06)" stroke="#4a9eed" strokeWidth="1"/>
      <text x="115" y="30" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Anchor-Based (Faster R-CNN, YOLOv3)</text>
      {/* object box */}
      <rect x={70} y={55} width={90} height={75} rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x={115} y={50} textAnchor="middle" fill="#4a9eed" fontSize="7">objecto real</text>
      {/* multiple anchors at center cell */}
      {[
        { x: 95, y: 75, w: 30, h: 30, c: '#4a9eed' },
        { x: 85, y: 65, w: 50, h: 50, c: '#4a9eed' },
        { x: 100, y: 80, w: 22, h: 44, c: '#4a9eed' },
      ].map((a, i) => (
      ...
      {/* Anchor-free panel */}
      <rect x={260} y={15} width={210} height={150} rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1"/>
      <text x="365" y="30" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Anchor-Free (FCOS, CenterNet)</text>
      <rect x={320} y={55} width={90} height={75} rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      {/* center point */}
      <circle cx={365} cy={92} r={3} fill="#4a9eed"/>
      <text x={365} y="50" textAnchor="middle" fill="#4a9eed" fontSize="7">objecto real</text>
      {/* distances l,t,r,b */}
      <line x1="365" y1="92" x2="320" y2="92" stroke="#4a9eed" strokeWidth="1" strokeDasharray="2,1"/>
      <line x1="365" y1="92" x2="410" y2="92" stroke="#4a9eed" strokeWidth="1" strokeDasharray="2,1"/>
      <line x1="365" y1="92" x2="365" y2="55" stroke="#4a9eed" strokeWidth="1" strokeDasharray="2,1"/>
      <line x1="365" y1="92" x2="365" y2="130" stroke="#4a9eed" strokeWidth="1" strokeDasharray="2,1"/>
      <text x="340" y="88" textAnchor="middle" fill="#4a9eed" fontSize="6.5">l</text>
      <text x="390" y="88" textAnchor="middle" fill="#4a9eed" fontSize="6.5">r</text>
      <text x="370" y="68" textAnchor="middle" fill="#4a9eed" fontSize="6.5">t</text>
      <text x="370" y="115" textAnchor="middle" fill="#4a9eed" fontSize="6.5">b</text>
  ...
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 460 230" style={{ maxWidth: '100%', height: 'auto' }}>
      ...
      {[
        ...
        <g key={i}>
          <rect x={60 - b.w/2} y={b.y} width={b.w} height={b.h} rx="3" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.2"/>
          <text x={60} y={b.y + b.h/2 + 3} textAnchor="middle" fill="#4a9eed" fontSize="7" fontWeight="700">{b.label.split(' ')[0]}</text>
        </g>
      ))}
      {/* arrows up the backbone — between boxes, not inside them */}
      {[[168,153],[123,106],[80,62]].map(([y1,y2], i) => (
        <line key={i} x1="60" y1={y1} x2="60" y2={y2} stroke="#4a9eed" strokeWidth="1.2" markerEnd="url(#fpnArrow)"/>
      ))}
      ...
      {[
        ...
        <g key={i}>
          <rect x={340 - b.w/2} y={b.y} width={b.w} height={b.h} rx="3" fill="rgba(74,158,237,0.15)" stroke="#4a9eed" strokeWidth="1.5"/>
          <text x={340} y={b.y + b.h/2 + 3} textAnchor="middle" fill="#4a9eed" fontSize="7" fontWeight="700">{b.label}</text>
        </g>
      ))}
      {/* arrows down top-down (upsample) — strictly between P boxes */}
      {[[62,80],[106,123],[153,168]].map(([y1,y2], i) => (
        <line key={i} x1="340" y1={y1} x2="340" y2={y2} stroke="#4a9eed" strokeWidth="1.2" markerEnd="url(#fpnArrow)"/>
      ))}
      ...
      {[42,82,125,170].map((y,i) => (
        <text key={i} x="430" y={y+(i===0?9:i===1?11:i===2?13:15)} textAnchor="middle" fill="#4a9eed" fontSize="6.5">→ head</text>
      ))}
    </svg>
  </div>
);
...
const LossDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 460 150" style={{ maxWidth: '100%', height: 'auto' }}>
      ...
      <rect x="40" y="30" width="90" height="70" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      <rect x="75" y="55" width="90" height="70" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="3,2"/>
      ...
      <rect x="270" y="30" width="60" height="60" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      <rect x="370" y="65" width="60" height="60" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="3,2"/>
      {/* enclosing box for GIoU */}
      <rect x="270" y="30" width="160" height="95" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1" strokeDasharray="1,2"/>
      <text x="345" y="138" textAnchor="middle" fill="var(--text-primary)" fontSize="7.5">IoU = 0 → sem gradiente</text>
      <text x="345" y="148" textAnchor="middle" fill="#4a9eed" fontSize="7.5">GIoU usa a "enclosing box" (roxo) → ainda dá gradiente</text>
    </svg>
  </div>
);
...
const TrackingDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 540 150" style={{ maxWidth: '100%', height: 'auto' }}>
      ...
      {/* Frame t */}
      <rect x="10" y="15" width="120" height="110" rx="6" fill="rgba(74,158,237,0.08)" stroke="#4a9eed" strokeWidth="1"/>
      <text x="70" y="10" textAnchor="middle" fill="var(--text-secondary)" fontSize="8" fontWeight="700">Frame t</text>
      <rect x="25" y="30" width="40" height="50" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="45" y="27" textAnchor="middle" fill="#4a9eed" fontSize="6.5">ID 1</text>
      <rect x="75" y="55" width="35" height="55" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="92" y="52" textAnchor="middle" fill="#4a9eed" fontSize="6.5">ID 2</text>

      {/* Arrow + detector */}
      <line x1="135" y1="70" x2="158" y2="70" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#trkArrow)"/>
      <text x="147" y="63" textAnchor="middle" fill="var(--text-secondary)" fontSize="6.5">detector</text>

      {/* Frame t+1 raw detections (no IDs) */}
      <rect x="163" y="15" width="120" height="110" rx="6" fill="rgba(74,158,237,0.04)" stroke="var(--text-secondary)" strokeWidth="1"/>
      ...
      <line x1="288" y1="70" x2="358" y2="70" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#trkArrow)"/>
      ...
      <rect x="363" y="15" width="165" height="110" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1"/>
      <text x="445" y="10" textAnchor="middle" fill="var(--text-secondary)" fontSize="8" fontWeight="700">Frame t+1 (tracks)</text>
      <rect x="380" y="35" width="40" height="50" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="400" y="32" textAnchor="middle" fill="#4a9eed" fontSize="6.5">ID 1</text>
      <rect x="435" y="58" width="35" height="55" rx="2" fill="none" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="452" y="55" textAnchor="middle" fill="#4a9eed" fontSize="6.5">ID 2</text>
      <text x="445" y="132" textAnchor="middle" fill="#4a9eed" fontSize="6.5" fontWeight="700">identidades preservadas</text>
    </svg>
  </div>
);
...
export default function CV9() {
  ...
  const detectors = [
    {
      name: 'Faster R-CNN', stage: '2-stage', color: '#4a9eed',
      year: '2015',
    ...
    {
      name: 'YOLO v1-v3', stage: '1-stage', color: '#4a9eed',
      year: '2016-2018',
    ...
    {
      name: 'YOLOv5-v9 / YOLO NAS', stage: '1-stage', color: '#4a9eed',
      year: '2020-2024',
    ...
    {
      name: 'DETR', stage: 'Transformer', color: '#4a9eed',
      year: '2020',
          ...
          <div style={S.diagram}>
            ...
            <div style={{ background: 'var(--bg-primary)', borderRadius: 10, padding: '1.25rem', border: `1.5px solid ${d.color}30` }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', fontSize: '0.85rem' }}>
                <div><strong style={{ color: '#4a9eed' }}>Vantagens:</strong><p style={{ marginTop: '0.3rem', lineHeight: 1.6, color: 'var(--text-primary)' }}>{d.pros}</p></div>
                <div><strong style={{ color: '#4a9eed' }}>Limitações:</strong><p style={{ marginTop: '0.3rem', lineHeight: 1.6, color: 'var(--text-primary)' }}>{d.cons}</p></div>
              </div>
            </div>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={f}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{f}</td><td style={S.td}>{p}</td><td style={S.td}>{w}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
        ...
        <div style={S.section}>
          ...
          <div style={S.diagram}>
            ...
            <div style={{ background: 'var(--bg-primary)', borderRadius: 10, padding: '1.25rem', border: `1.5px solid ${af.color}30` }}>
              ...
              <p style={{ fontSize: '0.85rem', lineHeight: 1.6 }}><strong style={{ color: '#4a9eed' }}>Vantagens:</strong> {af.pros}</p>
            </div>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={l}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{l}</td><td style={S.td}>{i}</td><td style={S.td}>{lim}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={m}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{m}</td><td style={S.td}>{desc}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
