...
export const modules = [
  ...
  { id: 'calc6', num: '06', title: 'Integrais & Probabilidade',            subtitle: 'Integral de Riemann, PDFs, CDFs e Valor Esperado',                   topics: ['Integral definido — área sob a curva', 'Teorema fundamental do cálculo', 'PDFs e CDFs — como se relacionam', 'Valor esperado E[X] e variância Var[X] como integrais'],                    path: '/calculus/lecture6', color: '#4a9eed' },
  { id: 'calc7', num: '07', title: 'Séries de Taylor & Aproximações',      subtitle: 'Expansões de Taylor, Raio de Convergência, Aproximações em ML',       topics: ['Série de Taylor — eˣ, sin, cos, log, sigmoid', 'Raio de convergência e resto de Lagrange', 'Aproximação quadrática — passo de Newton', 'GELU, log-sum-exp e perturbation analysis'],              path: '/calculus/lecture7', color: '#4a9eed' },
  { id: 'calc8', num: '08', title: 'Cálculo Vetorial',                      subtitle: 'Gradiente, Divergência, Rotacional, Laplaciano e Normalizing Flows',  topics: ['Operador nabla — gradiente, divergência, rotacional', 'Laplaciano e campos conservativos', 'Jacobiano em mudança de variáveis', 'Normalizing flows e cálculo em grafos (GNNs)'],              path: '/calculus/lecture8', color: '#4a9eed' },
  { id: 'calc9', num: '09', title: 'Equações Diferenciais Ordinárias',    subtitle: 'EDOs, Métodos Numéricos, Neural ODEs e Difusão',                      topics: ['EDOs separáveis, lineares e sistemas', 'Euler, RK4 e scipy.integrate.solve_ivp', 'ResNets como discretização de Euler — Neural ODEs', 'Adjoint method, SDEs e modelos de difusão'],            path: '/calculus/lecture9', color: '#4a9eed' },
  { id: 'calc10', num: '10', title: 'Transformada de Fourier',              subtitle: 'Série de Fourier, DFT, FFT, Wavelets e Fourier Neural Operators',     topics: ['Série de Fourier e fenómeno de Gibbs', 'DFT e FFT — O(N²) vs O(N log N)', 'Positional encodings e análise espectral', 'Wavelets e Fourier Neural Operators (FNO)'],                    path: '/calculus/lecture10', color: '#4a9eed' },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1rem 4rem' }}>
      ...
      <div style={{ marginBottom: '2.5rem' }}>
        <div style={{ display: 'inline-block', background: 'transparent', color: '#4a9eed', border: '1.5px solid #4a9eed', fontSize: '0.75rem', fontWeight: 700, padding: '0.25rem 0.75rem', borderRadius: 20, marginBottom: '0.75rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>CALCULUS</div>
        <h1 style={{ fontSize: '2.2rem', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '0.5rem' }}>Calculus</h1>
