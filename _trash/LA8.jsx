...
function TensorHierarchySVG() {
  return (
    <svg width="820" height="210" viewBox="0 0 820 210" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      {/* Escalar */}
      <rect x="10" y="90" width="130" height="60" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ...
      {/* Vetor */}
      <rect x="160" y="65" width="140" height="80" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ...
      {/* Matriz */}
      <rect x="322" y="42" width="155" height="100" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ...
      {/* Tensor 3D */}
      <rect x="500" y="20" width="155" height="125" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ...
      {/* Tensor 4D */}
      <rect x="678" y="8" width="135" height="135" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
  ...
  return (
    <svg width="760" height="235" viewBox="0 0 760 235" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      {[80, 110, 140, 170].map((y, i) => (
        <circle key={i} cx="55" cy={y} r="13" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ))}
      ...
      {[80, 110, 140, 170].map((y, i) => (
        <circle key={i} cx="565" cy={y} r="10" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ))}
...
function LossSurfaceSVG() {
  return (
    <svg width="420" height="280" viewBox="0 0 420 280" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      <line x1="310" y1="100" x2="255" y2="118" stroke="#4a9eed" strokeWidth="2.5" markerEnd="url(#arrow)"/>
      <defs>
        <marker id="arrow" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
          <path d="M0,0 L0,6 L8,3 z" fill="#4a9eed"/>
        </marker>
      </defs>
      <text x="273" y="125" fontSize="10" fill="#4a9eed" fontWeight="600">-∇L</text>
      <text x="268" y="135" fontSize="10" fill="#4a9eed">(gradiente)</text>
...
function CompGraphSVG() {
  return (
    <svg width="760" height="265" viewBox="0 0 760 265" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      {/* L */}
      <rect x="602" y="70" width="80" height="70" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="2"/>
      ...
      {/* Backward arc */}
      <path d="M642 140 Q642 200 402 200 Q281 200 160 175" fill="none" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="5 3" markerEnd="url(#arr3)"/>
      <text x="400" y="240" textAnchor="middle" fontSize="11" fill="#4a9eed">backpropagation — regra da cadeia com transposta de matrizes</text>
    </svg>
  );
}
  ...
  return (
    <svg width="760" height="260" viewBox="0 0 760 260" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      {[90, 120, 150, 180, 210].map((y, i) => (
        <rect key={i} x="18" y={y} width="64" height="14" rx="2" fill={`rgba(74,158,237,0.10)`}/>
      ))}
      ...
      {[90, 120, 150, 180, 210].map((y, i) => (
        <rect key={i} x="123" y={y} width="64" height="14" rx="2" fill="rgba(74,158,237,0.10)"/>
      ))}
      ...
      {[90, 120, 150, 180, 210].map((y, i) => (
        <rect key={i} x="248" y={y} width="64" height="14" rx="2" fill="rgba(74,158,237,0.10)"/>
      ))}
      ...
      <rect x="465" y="50" width="120" height="190" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="2"/>
      ...
      {[90, 110, 130, 150, 170, 190, 210].map((y, i) => (
        [0, 1, 2, 3].map((j) => (
          <rect key={j} x={473 + j * 26} y={y} width="22" height="14" rx="2" fill={`rgba(74,158,237,0.10) * 0.4 + 0.05})`}/>
        ))
      ))}
      ...
      {[90, 120, 150, 180, 210].map((y, i) => (
        <rect key={i} x="628" y={y} width="64" height="14" rx="2" fill="rgba(74,158,237,0.10)"/>
      ))}
...
function WeightInitSVG() {
  const bars = [
    ...
    { x: 270, h: 45, label: 'Kaiming/He', color: '#4a9eed' },
    { x: 390, h: 70, label: 'sem init', color: '#4a9eed' },
  ];
  return (
  ...
  return (
    <svg width="640" height="200" viewBox="0 0 640 200" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      {[-30, -10, 5, 25, 60, 90, 120].map((dx, i) => (
        <ellipse key={i} cx={160 + dx} cy={110 + (i % 3) * 20 - 20} rx={12 + i * 3} ry="8" fill={`rgba(74,158,237,0.10)`} stroke={color} strokeWidth="1"/>
      ))}
      ...
      {[-30, -15, 0, 15, 30].map((dx, i) => (
        <ellipse key={i} cx={500 + dx} cy={100 + (i % 2) * 18 - 10} rx="22" ry="9" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1"/>
      ))}
      ...
      <line x1="340" y1="155" x2="620" y2="155" stroke="#4a9eed" strokeWidth="1" strokeDasharray="3 3"/>
      <text x="160" y="168" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">eixo: média de cada feature</text>
      <text x="500" y="168" textAnchor="middle" fontSize="10" fill="#4a9eed">normalizado</text>
    </svg>
  );
}
      ...
      {vals.map((row, i) =>
        row.map((val, j) => (
          <rect key={j} x={10 + j * 32} y={30 + i * 32} width="30" height="30" rx="3"
            fill={val !== 0 ? `rgba(74,158,237,0.10)` : 'var(--bg-secondary)'}
...
function EmbeddingSVG() {
  const points = [
    { x: 80, y: 60, label: 'rei', color: '#4a9eed' },
    { x: 130, y: 80, label: 'rainha', color: '#4a9eed' },
    { x: 85, y: 110, label: 'homem', color: '#4a9eed' },
    { x: 135, y: 130, label: 'mulher', color: '#4a9eed' },
    { x: 260, y: 70, label: 'gato', color: '#4a9eed' },
    { x: 310, y: 90, label: 'cão', color: '#4a9eed' },
    { x: 265, y: 120, label: 'peixe', color: '#4a9eed' },
    { x: 80, y: 200, label: 'correr', color: '#4a9eed' },
    { x: 140, y: 210, label: 'saltar', color: '#4a9eed' },
  ];
  return (
    <svg width="420" height="280" viewBox="0 0 420 280" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      <ellipse cx="108" cy="90" rx="55" ry="45" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1" strokeDasharray="4 3"/>
      <text x="108" y="170" textAnchor="middle" fontSize="10" fill="#4a9eed">realeza</text>

      <ellipse cx="285" cy="95" rx="55" ry="40" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1" strokeDasharray="4 3"/>
      <text x="285" y="175" textAnchor="middle" fontSize="10" fill="#4a9eed">animais</text>

      <ellipse cx="110" cy="205" rx="55" ry="25" fill="rgba(74,158,237,0.07)" stroke="#4a9eed" strokeWidth="1" strokeDasharray="4 3"/>
      <text x="110" y="245" textAnchor="middle" fontSize="10" fill="#4a9eed">acções</text>
      ...
      <line x1="80" y1="60" x2="135" y2="80" stroke="#4a9eed" strokeWidth="1" strokeDasharray="3 2"/>
...
function LoRASVG() {
  return (
    <svg width="680" height="200" viewBox="0 0 680 200" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      <rect x="10" y="30" width="160" height="120" rx="6" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="2"/>
      {Array.from({ length: 8 }).map((_, i) =>
        Array.from({ length: 6 }).map((__, j) => (
          <rect key={j} x={18 + j * 24} y={38 + i * 14} width="20" height="11" rx="1" fill={`rgba(74,158,237,0.10) * 0.2})`}/>
        ))
      )}
      ...
      <rect x="355" y="30" width="40" height="120" rx="4" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="2"/>
      ...
      <rect x="405" y="65" width="70" height="35" rx="4" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="2"/>
...
function FlashAttentionSVG() {
  return (
    <svg width="680" height="200" viewBox="0 0 680 200" style={{ display: 'block', margin: '1rem auto', maxWidth: '100%' }}>
      ...
      <rect x="20" y="35" width="60" height="70" rx="4" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ...
      <rect x="110" y="40" width="80" height="60" rx="4" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="150" y="64" textAnchor="middle" fontSize="10" fill="#4a9eed">S = QKᵀ</text>
      ...
      <rect x="220" y="40" width="60" height="60" rx="4" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="250" y="64" textAnchor="middle" fontSize="9" fill="#4a9eed">softmax</text>
      <text x="250" y="80" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">·V → Out</text>
      <text x="150" y="128" textAnchor="middle" fontSize="10" fill="#4a9eed">lê/escreve S de HBM (lento!)</text>
      ...
      <rect x="310" y="35" width="60" height="70" rx="4" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ...
      <rect x="400" y="35" width="120" height="70" rx="4" fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5"/>
      ...
      <rect x="550" y="40" width="60" height="60" rx="4" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="580" y="68" textAnchor="middle" fontSize="10" fill="#4a9eed">Out</text>
