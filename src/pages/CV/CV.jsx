...
export const modules = [
  ...
  },
  {
    ...
    path: '/cv/lecture10', color: '#4a9eed',
  },
  {
    id: 'cv11', num: '11',
    ...
    path: '/cv/lecture11', color: '#4a9eed',
  },
];
