...
export const modules = [
  {
    ...
    path: '/mlops/lecture1', color: '#4a9eed',
  },
  {
    id: 'mlops2', num: '02',
    ...
    path: '/mlops/lecture2', color: '#4a9eed',
  },
  {
    id: 'mlops3', num: '03',
    ...
    path: '/mlops/lecture3', color: '#4a9eed',
  },
  {
    id: 'mlops5', num: '04',
    ...
    path: '/mlops/lecture5', color: '#4a9eed',
  },
  {
    id: 'mlops6', num: '05',
    title: 'Data Drift & Concept Drift',
    subtitle: 'Tipos de drift, detecção e reacção a mudanças na distribuição dos dados',
    topics: ['Sudden, Gradual, Incremental & Recurring drift', 'Data drift / Covariate shift', 'Label drift & Concept drift', 'Algoritmos de detecção: ADWIN, DDM, KSWIN', 'Adaptive Random Forest — resposta automática ao drift'],
    path: '/mlops/lecture6', color: '#4a9eed',
  },
];
