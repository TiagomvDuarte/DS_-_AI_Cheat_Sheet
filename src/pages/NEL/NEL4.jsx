...
const BloatDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 560 130" style={{ maxWidth: '100%', height: 'auto' }}>
      <defs>
        <marker id="arr-bl" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#4a9eed"/></marker>
      </defs>
      {[
        ...
        <g key={i}>
          <circle cx={x} cy={60} r={size} fill="#0369a115" stroke="#4a9eed" strokeWidth="1.5"/>
          <text x={x} y={64} textAnchor="middle" fill="#4a9eed" fontSize={Math.min(size * 0.7, 9)} fontWeight="700">T{i}</text>
          ...
          {i < 3 && <line x1={x + size + 3} y1={60} x2={[150, 300, 460][i] - [12, 22, 40][i] - 3} y2={60} stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-bl)"/>}
        </g>
      ))}
      <text x="280" y="14" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Tamanho cresce O(G) — após 100 gerações: modelo com milhares de nós</text>
    </svg>
  </div>
);
...
const MegaTreeEvolutionDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 1000 360" style={{ minWidth: '1000px', height: 'auto' }}>
      ...
      {/* ========================================== */}
      <rect x="10" y="5" width="980" height="110" rx="8" fill="rgba(74,158,237,0.10)" stroke="var(--text-secondary)" strokeWidth="1" />
      <text x="25" y="24" fill="#4a9eed" fontSize="11" fontWeight="700">ESTRUTURA DETALHADA DAS SUBÁRVORES FIXAS E IMUTÁVEIS (EXEMPLOS REAIS)</text>

      {/* Árvore Inicial T - REDESENHADA MAIOR */}
      <g transform="translate(30, 35)">
        <rect x="5" y="2" width="130" height="70" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" />
        <text x="70" y="16" textAnchor="middle" fill="var(--text-primary)" fontSize="11" fontWeight="800">Árvore Base T</text>
        <circle cx="70" cy="32" r="8" fill="#4a9eed" /><text x="70" y="36" textAnchor="middle" fill="#fff" fontSize="11" fontWeight="700">+</text>
      ...
      <g transform="translate(250, 45)">
        ...
        <circle cx="30" cy="24" r="8" fill="none" stroke="#4a9eed" strokeWidth="1.5"/><text x="30" y="27.5" textAnchor="middle" fill="#4a9eed" fontSize="8" fontWeight="700">sin</text>
        <line x1="30" y1="32" x2="30" y2="46" stroke="#4a9eed" strokeWidth="1.2"/>
      ...
      <g transform="translate(430, 45)">
        <text x="30" y="10" textAnchor="middle" fill="var(--text-primary)" fontSize="10" fontWeight="700">Subárvore R₂</text>
        <circle cx="30" cy="24" r="8" fill="none" stroke="#4a9eed" strokeWidth="1.5"/><text x="30" y="27.5" textAnchor="middle" fill="#4a9eed" fontSize="8" fontWeight="700">log</text>
        <line x1="30" y1="32" x2="30" y2="46" stroke="#4a9eed" strokeWidth="1.2"/>
        <text x="30" y="58" textAnchor="middle" fill="var(--text-secondary)" fontSize="9">x₄</text>
      </g>
      ...
      <g transform="translate(620, 45)">
        <text x="30" y="10" textAnchor="middle" fill="var(--text-primary)" fontSize="10" fontWeight="700">Subárvore R₃</text>
        <circle cx="30" cy="24" r="8" fill="none" stroke="#4a9eed" strokeWidth="1.5"/><text x="30" y="27.5" textAnchor="middle" fill="#4a9eed" fontSize="8" fontWeight="700">cos</text>
        <line x1="30" y1="32" x2="30" y2="46" stroke="#4a9eed" strokeWidth="1.2"/>
        <text x="30" y="58" textAnchor="middle" fill="var(--text-secondary)" fontSize="9">x₃</text>
      </g>
      ...
      <g transform="translate(810, 45)">
        <text x="30" y="10" textAnchor="middle" fill="var(--text-primary)" fontSize="10" fontWeight="700">Subárvore R₄</text>
        <circle cx="30" cy="24" r="8" fill="none" stroke="#4a9eed" strokeWidth="1.5"/><text x="30" y="27.5" textAnchor="middle" fill="#4a9eed" fontSize="8" fontWeight="700">sqrt</text>
        <line x1="30" y1="32" x2="30" y2="46" stroke="#4a9eed" strokeWidth="1.2"/>
        <text x="30" y="58" textAnchor="middle" fill="var(--text-secondary)" fontSize="9">x₁</text>
      </g>
      ...
      <g transform="translate(10, 160)">
        ...
        <rect x="15" y="40" width="70" height="35" rx="6" fill="none" stroke="#4a9eed" strokeWidth="2" />
      ...
      <g transform="translate(160, 160)">
        <text x="65" y="15" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">2. Inflate + (G1)</text>
        
        <line x1="65" y1="40" x2="30" y2="75" stroke="var(--text-primary)" strokeWidth="1.5" />
        <line x1="65" y1="40" x2="100" y2="75" stroke="#4a9eed" strokeWidth="1.5" />
        <line x1="100" y1="75" x2="100" y2="110" stroke="#4a9eed" strokeWidth="1.5" />
        <line x1="100" y1="110" x2="80" y2="140" stroke="#4a9eed" strokeWidth="1.2" />
        <line x1="100" y1="110" x2="120" y2="140" stroke="#4a9eed" strokeWidth="1.2" />

        <circle cx="65" cy="40" r="12" fill="#4a9eed" />
        ...
        <circle cx="100" cy="75" r="10" fill="var(--bg-secondary)" stroke="#4a9eed" strokeWidth="1.5" />
        <text x="100" y="78" textAnchor="middle" fill="var(--text-primary)" fontSize="10">ms</text>

        <circle cx="100" cy="110" r="10" fill="none" stroke="#4a9eed" strokeWidth="1.5" />
        <text x="100" y="113.5" textAnchor="middle" fill="#4a9eed" fontSize="13" fontWeight="700">-</text>

        <rect x="65" y="140" width="28" height="20" rx="3" fill="var(--bg-secondary)" stroke="#4a9eed" strokeWidth="1.2" />
        <text x="79" y="153" textAnchor="middle" fill="var(--text-primary)" fontSize="10" fontWeight="600">R₁</text>

        <rect x="107" y="140" width="28" height="20" rx="3" fill="var(--bg-secondary)" stroke="#4a9eed" strokeWidth="1.2" />
      ...
      <g transform="translate(370, 160)">
        <text x="65" y="15" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">3. Insuflado (G2)</text>
        
        <circle cx="65" cy="35" r="11" fill="#4a9eed" />
        ...
        <circle cx="35" cy="65" r="8" fill="#4a9eed" /><text x="35" y="68" textAnchor="middle" fill="#fff" fontSize="9">+</text>
        ...
        <line x1="72" y1="42" x2="95" y2="65" stroke="#4a9eed" strokeWidth="1.2" />
        <circle cx="95" cy="65" r="7" fill="var(--bg-secondary)" stroke="#4a9eed" strokeWidth="1.2" /><text x="95" y="67.5" textAnchor="middle" fill="var(--text-primary)" fontSize="8">ms</text>
        <line x1="95" y1="72" x2="95" y2="88" stroke="#4a9eed" strokeWidth="1.2" />
        <circle cx="95" cy="94" r="7" fill="none" stroke="#4a9eed" strokeWidth="1.2" /><text x="95" y="96.5" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">-</text>
        
        <line x1="90" y1="100" x2="80" y2="115" stroke="#4a9eed" strokeWidth="1" />
        <text x="78" y="125" textAnchor="middle" fill="var(--text-secondary)" fontSize="8">R₃</text>
        <line x1="100" y1="100" x2="110" y2="115" stroke="#4a9eed" strokeWidth="1" />
        <text x="112" y="125" textAnchor="middle" fill="var(--text-secondary)" fontSize="8">R₄</text>

        <text x="65" y="155" textAnchor="middle" fill="#4a9eed" fontSize="8" fontWeight="700">[Insuflado / Bloat]</text>
      </g>
      ...
      <g transform="translate(570, 160)">
        <text x="110" y="15" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">4. Deflate: Poda e Simplificação Mecânica (G3)</text>
        
        {/* Raiz unificada com o sinal de subtração global */}
        <circle cx="100" cy="45" r="12" fill="#4a9eed" />
        ...
        <line x1="108" y1="52" x2="145" y2="85" stroke="#4a9eed" strokeWidth="1.5" />
        <rect x="120" y="85" width="65" height="25" rx="4" fill="var(--bg-secondary)" stroke="#4a9eed" />
        <text x="152.5" y="100" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="600">ms · (R₃ - R₄)</text>

        {/* RAMO ELIMINADO - CORRIGIDO PARA SUBTRAÇÃO SIMÉTRICA (ANULAÇÃO) */}
        <g opacity="0.2">
          <line x1="88" y1="50" x2="10" y2="115" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="3 3"/>
          <circle cx="10" cy="115" r="8" fill="#4a9eed" /><text x="10" y="118.5" textAnchor="middle" fill="#fff" fontSize="10" fontWeight="700">-</text>
          <line x1="10" y1="123" x2="-5" y2="140" stroke="#4a9eed" strokeWidth="1"/>
          <line x1="10" y1="123" x2="25" y2="140" stroke="#4a9eed" strokeWidth="1"/>
        ...
        <line x1="-20" y1="140" x2="50" y2="105" stroke="#4a9eed" strokeWidth="3" />
        <line x1="-20" y1="105" x2="50" y2="140" stroke="#4a9eed" strokeWidth="3" />
        <text x="15" y="165" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="900" letterSpacing="0.05em">PODA: - ms·(R₁-R₂) ANULADO</text>
        
        {/* Seta de Equivalência Semântica */}
        <text x="210" y="95" textAnchor="middle" fill="#4a9eed" fontSize="16" fontWeight="700">→</text>
        
        {/* Bloco Limpo Compactado Final */}
        <rect x="235" y="80" width="130" height="35" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" />
        <text x="300" y="101" textAnchor="middle" fill="#4a9eed" fontSize="11" fontWeight="700">Modelo Desinsuflado</text>
...
const ArchitectureDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 560 140" style={{ maxWidth: '100%', height: 'auto' }}>
      ...
      <rect x="490" y="50" width="40" height="40" rx="6" fill="#4a9eed" />
      ...
      {[
        { name: 'Árvore Inicial (T)', op: '+', x: 70, color: '#4a9eed' },
        { name: 'ms · (R₁ - R₂)', op: '+', x: 180, color: '#4a9eed' },
        { name: 'ms · (R₃ - R₄)', op: '-', x: 290, color: '#4a9eed' },
        { name: 'ms · (R₅ - R₆)', op: '+', x: 400, color: '#4a9eed' }
      ].map((block, i) => (
        <g key={i}>
...
const TradeoffDiagram = () => (
  <div style={{ ...S.diagram, textAlign: 'center' }}>
    ...
    <svg viewBox="0 0 560 160" style={{ maxWidth: '100%', height: 'auto' }}>
      ...
      <path d="M 50 120 L 150 100 L 250 75 L 350 45 L 450 15" fill="none" stroke="#7dd3fc" strokeWidth="2" />
      <text x="455" y="20" fill="#7dd3fc" fontSize="8" fontWeight="700">GSGP (Explosão Sem Fim)</text>
      <path d="M 50 120 Q 120 90 200 95 T 350 70 T 450 60" fill="none" stroke="#94a3b8" strokeWidth="1.5" strokeDasharray="3 3" />
      <text x="455" y="60" fill="#94a3b8" fontSize="8">GP Clássico</text>
      <path d="M 50 120 L 100 110 L 150 100 L 180 115 L 230 105 L 280 95 L 300 110 L 350 102 L 400 92 L 420 110 L 450 103" fill="none" stroke="#1e3a8a" strokeWidth="2" />
      <text x="455" y="105" fill="#1e3a8a" fontSize="8" fontWeight="700">SLIM_GSGP (Estável)</text>
      <circle cx="180" cy="115" r="3" fill="#1e3a8a" />
      <circle cx="300" cy="110" r="3" fill="#1e3a8a" />
      <circle cx="420" cy="110" r="3" fill="#1e3a8a" />
      <text x="300" y="123" textAnchor="middle" fill="#1e3a8a" fontSize="7">Mutações Deflate (Cancelamento)</text>
    </svg>
  </div>
);
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={op}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{op}</td><td style={S.td}>{sz}</td><td style={S.td}>{ft}</td><td style={{ ...S.td, color: 'var(--text-secondary)', fontSize: '0.85rem' }}>{wh}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={alg}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{alg}</td><td style={S.td}>{surf}</td><td style={S.td}>{size}</td><td style={S.td}>{interp}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
