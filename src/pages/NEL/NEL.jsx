...
export const modules = [
  {
    ...
    path: '/nel/lecture2', color: '#f97316',
  },
  {
    id: 'nel3', num: '02',
    ...
    path: '/nel/lecture3', color: '#f97316',
  },
  {
    id: 'nel4', num: '03',
    title: 'SLIM_GSGP',
    ...
    path: '/nel/lecture4', color: '#f97316',
  },
  {
    id: 'nel5', num: '04',
    ...
    path: '/nel/lecture5', color: '#f97316',
  },
  {
    id: 'nel6', num: '05',
    title: 'NEAT',
    ...
    path: '/nel/lecture6', color: '#f97316',
  },
  {
    id: 'nel7', num: '06',
    ...
    path: '/nel/lecture7', color: '#f97316',
  },
  {
    id: 'nel8', num: '07',
    ...
    path: '/nel/lecture8', color: '#f97316',
  },
  {
    id: 'nel9', num: '08',
    ...
    path: '/nel/lecture9', color: '#f97316',
  },
  {
    id: 'nel10', num: '09',
    ...
    path: '/nel/lecture10', color: '#f97316',
  },
];
    ...
    <div style={{ padding: '2rem 1rem' }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '3rem' }}>
          ...
          <h1 style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '0.5rem' }}>Neural and Evolutionary Learning</h1>
