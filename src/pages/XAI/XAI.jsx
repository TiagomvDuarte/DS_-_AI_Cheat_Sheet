...
export const modules = [
  { id: 'xai1', num: '01', title: 'Introdução ao XAI',                   subtitle: 'Black Box vs. White Box, Taxonomia e Necessidade de Explicabilidade',  topics: ['Black box vs. white box models', 'Ante-hoc vs. post-hoc explainability', 'Local vs. global explanations', 'Model-agnostic vs. model-specific methods'], path: '/xai/lecture1', color: '#f97316' },
  { id: 'xai2', num: '02', title: 'Feature Importance Global',            subtitle: 'Permutation Importance, MDI e Partial Dependence Plots',                topics: ['Permutation Feature Importance', 'Mean Decrease in Impurity (MDI)', 'Partial Dependence Plots (PDP)', 'Individual Conditional Expectation (ICE)'], path: '/xai/lecture2', color: '#f97316' },
  { id: 'xai3', num: '03', title: 'LIME',                                 subtitle: 'Local Interpretable Model-agnostic Explanations',                       topics: ['Perturbação local de instâncias', 'Modelo substituto linear local', 'Fidelidade vs. interpretabilidade', 'LIME para texto, imagem e tabular'], path: '/xai/lecture3', color: '#f97316' },
  { id: 'xai4', num: '04', title: 'SHAP',                                 subtitle: 'Shapley Values, TreeSHAP, DeepSHAP e Visualizações',                   topics: ['Shapley values — teoria dos jogos', 'SHAP = Shapley Additive exPlanations', 'TreeSHAP (eficiente) e DeepSHAP', 'Force plots, summary plots, waterfall'], path: '/xai/lecture4', color: '#f97316' },
  { id: 'xai5', num: '05', title: 'Métodos Visuais & Model-Specific',      subtitle: 'Grad-CAM, Saliency Maps, Attention e TCAV',                           topics: ['Grad-CAM e Score-CAM para CNNs', 'Saliency maps e Integrated Gradients', 'Attention weights em Transformers', 'TCAV — explicações por conceitos'], path: '/xai/lecture5', color: '#f97316' },
  { id: 'xai6', num: '06', title: 'Responsible AI',                       subtitle: 'Fairness, Bias, EU AI Act e XAI em Produção',                           topics: ['Métricas de fairness (demographic parity, equalized odds)', 'Bias: fontes e deteção', 'EU AI Act — obrigações de transparência', 'XAI em produção: challenges e boas práticas'], path: '/xai/lecture6', color: '#f97316' },
  { id: 'xai7', num: '07', title: 'Counterfactuals & Algorithmic Recourse', subtitle: 'DiCE, FACE, Influence Functions e Explicações Accionáveis',            topics: ['Counterfactual explanations — o mínimo a mudar', 'DiCE — Diverse Counterfactual Explanations', 'Influence functions — atribuição aos dados de treino', 'Algorithmic recourse e accionabilidade'], path: '/xai/lecture7', color: '#f97316' },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1rem 4rem' }}>
      ...
      <div style={{ marginBottom: '2.5rem' }}>
        <div style={{ display: 'inline-block', background: 'transparent', color: '#f97316', border: '1.5px solid #f97316', fontSize: '0.75rem', fontWeight: 700, padding: '0.25rem 0.75rem', borderRadius: 20, marginBottom: '0.75rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>EXPLAINABLE AI</div>
