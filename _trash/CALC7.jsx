...
function LossLandscapeSVG() {
  ...
  return (
    <svg viewBox="0 0 280 160" width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500 }}>
      ...
      <path d={ceD} fill="none" stroke="#4a9eed" strokeWidth="2" strokeDasharray="4 2" />
      <text x="220" y="60" fontSize="9" fill={color}>MSE</text>
      <text x="270" y="74" fontSize="9" fill="#4a9eed">Cross-Ent.</text>
    ...
    <svg viewBox="0 0 280 160" width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500 }}>
      ...
      {[1, 0.7, 0.45, 0.22].map((s, i) => (
        <ellipse key={i} cx={cx} cy={cy} rx={rx * s} ry={ry * s}
          fill="none" stroke={`rgba(74,158,237,0.10)`} strokeWidth="1" />
      ))}
...
function AdamSVG() {
  ...
  return (
    <svg viewBox={`0 0 ${w} ${h}`} width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500 }}>
      ...
      <text x="200" y="30" fontSize="8" fill="#4a9eed">m_t (biased)</text>
...
function RegularizationSVG() {
  return (
    <svg viewBox="0 0 280 160" width="100%" style={{ display: 'block', maxWidth: 420, margin: '0 auto' }} overflow="hidden">
      ...
      {/* L1 diamond */}
      <polygon points="210,35 255,80 210,125 165,80" fill="none" stroke="#4a9eed" strokeWidth="1.5" />
      {/* Loss contours ellipses */}
      {[25, 38, 52].map((r, i) => (
        <ellipse key={i} cx="70" cy="55" rx={r * 1.4} ry={r * 0.7}
          fill="none" stroke="rgba(74,158,237,0.10)" strokeWidth="0.8" />
      ))}
      {[25, 38, 52].map((r, i) => (
      ...
      <circle cx="165" cy="80" r="4" fill="#4a9eed" />
      <text x="70" y="28" fontSize="8" fill={color} textAnchor="middle">L2: solução densa</text>
      <text x="153" y="90" fontSize="8" fill="#4a9eed" textAnchor="end">L1: sparse</text>
      <text x="70" y="150" fontSize="9" fill={color} textAnchor="middle">Bola L2</text>
      <text x="210" y="150" fontSize="9" fill="#4a9eed" textAnchor="middle">Bola L1</text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 280 160" width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500 }}>
      ...
      {layers.map((lx, i) => {
        ...
        return <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="#4a9eed" strokeWidth="2" />;
      })}
      {layers.map((lx, i) => (
        <circle key={i} cx={20 + lx * 0.93} cy={130 - vars[i] * 50} r="4" fill="#4a9eed" />
      ))}
      {/* Good init (Xavier) */}
      {layers.map((lx, i) => {
        if (i === 0) return null;
      ...
      <text x="220" y="30" fontSize="8" fill="#4a9eed">Init má</text>
...
function BatchNormSVG() {
  ...
  return (
    <svg viewBox="0 0 290 165" width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500, margin: '0 auto' }}>
      ...
      <path d={dBefore} fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" />
      <path d={dAfter} fill="rgba(74,158,237,0.10)" stroke={color} strokeWidth="1.5" />
      <text x="34" y="158" fontSize="9" fill="#4a9eed" textAnchor="middle">Antes BN</text>
      <text x="175" y="158" fontSize="9" fill={color} textAnchor="middle">Depois BN</text>
      <text x="34" y="12" fontSize="8" fill="#4a9eed" textAnchor="middle">mu=0.8, sigma=1.4</text>
        ...
        row.map((s, i) => (
          <g key={`${j}-${i}`}>
            <rect x={38 + i * 40} y={40 + j * 35} width="34" height="28"
              fill={`rgba(74,158,237,0.10)`} rx="3" />
        ...
        row.map((v, i) => (
          <g key={`${j}-${i}`}>
            <rect x={10 + i * cellSize} y={20 + j * cellSize} width={cellSize - 1} height={cellSize - 1}
              fill="rgba(74,158,237,0.10)" stroke="var(--text-secondary)" strokeWidth="0.5" />
        ...
        row.map((v, i) => (
          <g key={`${j}-${i}`}>
            <rect x={140 + i * cellSize} y={20 + j * cellSize} width={cellSize - 1} height={cellSize - 1}
              fill={`rgba(74,158,237,0.10) * 0.3})`} stroke={color} strokeWidth="0.8" />
...
function RNNGradientSVG() {
  ...
  return (
    <svg viewBox="0 0 280 170" width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500 }}>
          ...
          <g key={i}>
            {i > 0 && (
              <line x1={30 + (i - 1) * 46} y1={130 - (Math.min(gradsExplode[i - 1], maxVal) / maxVal) * 115}
                x2={x} y2={y} stroke="#4a9eed" strokeWidth="2" />
            )}
            <circle cx={x} cy={y} r="3.5" fill="#4a9eed" />
          </g>
        );
      })}
      ...
      <text x="230" y="35" fontSize="8" fill="#4a9eed">{"rho(W) > 1"}</text>
  ...
  return (
    <svg viewBox="0 0 280 160" width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500 }}>
      ...
      <g transform="translate(70,80)">
        ...
        <line x1="-70" y1="-12" x2="-50" y2="10" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arrs)" />
        <line x1="-50" y1="10" x2="-30" y2="-8" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arrs)" />
        <line x1="-30" y1="-8" x2="-15" y2="5" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arrs)" />
        <line x1="-15" y1="5" x2="0" y2="0" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arrs)" />
        <text x="0" y="55" fontSize="8" fill="#4a9eed" textAnchor="middle">Gradiente Padrão</text>
      </g>
...
function VariationalSVG() {
  ...
  return (
    <svg viewBox="0 0 260 160" width="100%" overflow="visible" style={{ display: 'block', maxWidth: 500 }}>
      ...
      <path d={dC2} fill="none" stroke="rgba(74,158,237,0.10)" strokeWidth="1.5" strokeDasharray="4 3" />
      <path d={dC} fill="none" stroke="rgba(74,158,237,0.10)" strokeWidth="1.5" strokeDasharray="4 3" />
      ...
      <text x="130" y="30" fontSize="8" fill="rgba(74,158,237,0.10)" textAnchor="middle">variações admissíveis</text>
