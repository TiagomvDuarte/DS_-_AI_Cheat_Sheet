...
export const modules = [
  ...
  },
  {
    ...
    path: '/dv/lecture9', color: '#4a9eed',
  },
  {
    id: 'dv10', num: '10',
    title: 'Streamlit — Data Apps em Python',
    subtitle: 'Dashboards interactivos, widgets, visualizações e deploy',
    topics: ['Widgets: slider, selectbox, file_uploader', 'Layouts: columns, tabs, sidebar', 'Integração com Pandas, Plotly e Sklearn', 'Deploy: Streamlit Cloud, Docker'],
    path: '/dv/lecture10', color: '#4a9eed',
  },
];
