...
const ServiceStackDiagram = () => {
  ...
  const colColor = { 'On-Premises': '#94a3b8', IaaS: '#4a9eed', PaaS: '#4a9eed', SaaS: '#4a9eed' };
  return (
    <div style={S.diagram}>
      ...
      <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', marginTop: '0.9rem', fontSize: '0.78rem' }}>
        ...
        <span><span style={{ display: 'inline-block', width: 12, height: 12, background: 'rgba(74,158,237,0.10)', border: '1px solid #4a9eed', verticalAlign: 'middle', marginRight: 4 }} />Gere o fornecedor cloud</span>
      </div>
    </div>
  );
};
...
const ComputeDiagram = () => (
  <div style={S.diagram}>
    ...
    <svg viewBox="0 0 580 200" style={{ maxWidth: '100%', height: 'auto' }}>
      {/* VMs */}
      <text x="95" y="16" textAnchor="middle" fill="#4a9eed" fontSize="11" fontWeight="700">Máquinas Virtuais</text>
      ...
      {[88, 132].map((y) => (
        <g key={y}>
          <rect x="20" y={y - 22} width="65" height="42" rx="3" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.2"/>
          <text x="52" y={y - 8} textAnchor="middle" fill="#4a9eed" fontSize="7.5">Guest OS</text>
          <text x="52" y={y + 4} textAnchor="middle" fill="var(--text-secondary)" fontSize="7">App + libs</text>
          <rect x="105" y={y - 22} width="65" height="42" rx="3" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.2"/>
          <text x="137" y={y - 8} textAnchor="middle" fill="#4a9eed" fontSize="7.5">Guest OS</text>
      ...
      <text x="290" y="16" textAnchor="middle" fill="#4a9eed" fontSize="11" fontWeight="700">Contentores</text>
      ...
      {[100, 142].map((y, i) => (
        <g key={y}>
          <rect x="220" y={y} width="70" height="32" rx="3" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.2"/>
          <text x="255" y={y + 20} textAnchor="middle" fill="#4a9eed" fontSize="8">App {i*2+1}</text>
          <rect x="300" y={y} width="70" height="32" rx="3" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.2"/>
          <text x="335" y={y + 20} textAnchor="middle" fill="#4a9eed" fontSize="8">App {i*2+2}</text>
        </g>
      ))}
      ...
      <text x="490" y="16" textAnchor="middle" fill="#4a9eed" fontSize="11" fontWeight="700">Serverless (FaaS)</text>
      ...
      {[100, 142].map((y, i) => (
        <rect key={y} x="455" y={y} width="80" height="32" rx="16" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.2"/>
      ))}
      <text x="495" y="120" textAnchor="middle" fill="#4a9eed" fontSize="8">function()</text>
      <text x="495" y="162" textAnchor="middle" fill="#4a9eed" fontSize="8">function()</text>
...
const RegionAZDiagram = () => (
  <div style={S.diagram}>
    ...
    <svg viewBox="0 0 560 220" style={{ maxWidth: '100%', height: 'auto' }}>
      <rect x="20" y="20" width="340" height="180" rx="10" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="5,3"/>
      <text x="190" y="42" textAnchor="middle" fill="#4a9eed" fontSize="11" fontWeight="700">Region (ex: eu-west-1)</text>
      {[ [40, 'AZ-a'], [140, 'AZ-b'], [240, 'AZ-c'] ].map(([x, name]) => (
        <g key={name}>
          <rect x={x} y="60" width="90" height="120" rx="7" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
          <text x={x + 45} y="80" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">{name}</text>
      ...
      {/* Edge locations */}
      <text x="460" y="42" textAnchor="middle" fill="#4a9eed" fontSize="11" fontWeight="700">Edge Locations (CDN)</text>
      {[ [400, 70], [490, 70], [400, 130], [490, 130] ].map(([x, y], i) => (
        <g key={i}>
          <rect x={x} y={y} width="70" height="36" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.2"/>
          <text x={x + 35} y={y + 22} textAnchor="middle" fill="#4a9eed" fontSize="8">PoP {i + 1}</text>
        </g>
      ))}
...
const AutoScalingDiagram = () => (
  <div style={S.diagram}>
    ...
    <svg viewBox="0 0 520 195" style={{ maxWidth: '100%', height: 'auto' }}>
      ...
      <rect x="290" y="20" width="220" height="155" rx="8" fill="rgba(74,158,237,0.05)" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="5,3"/>
      <text x="400" y="14" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Auto-scaling Group</text>
      <text x="400" y="188" textAnchor="middle" fill="#4a9eed" fontSize="8">min=1, desired=2, max=5</text>
      {/* Utilizadores */}
      <rect x="10" y="68" width="90" height="40" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="55" y="92" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Utilizadores</text>
      {/* Load Balancer */}
      <line x1="100" y1="88" x2="143" y2="88" stroke="var(--text-secondary)" strokeWidth="1.2" markerEnd="url(#arr-as)"/>
      <rect x="145" y="68" width="105" height="40" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="197" y="92" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Load Balancer</text>
      ...
      {[35, 80, 125].map((y, i) => (
        <g key={y}>
          ...
          <rect x="305" y={y} width="185" height="38" rx="6" fill="rgba(74,158,237,0.12)" stroke="#4a9eed" strokeWidth="1.5"/>
          <text x="397" y={y + 23} textAnchor="middle" fill="#4a9eed" fontSize="8.5" fontWeight="700">Instância {i + 1}</text>
        </g>
      ))}
...
const CostExplorer = () => {
  ...
  const models = [
    ...
    {
      name: 'Reserved / Committed', color: '#4a9eed',
    ...
    {
      name: 'Spot / Preemptible', color: '#4a9eed',
    ...
    {
      name: 'Free Tier / Pay-as-you-go', color: '#4a9eed',
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={m}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed', fontSize: '0.85rem' }}>{m}</td><td style={S.td}>{r}</td><td style={{ ...S.td, fontSize: '0.85rem', color: 'var(--text-secondary)' }}>{g}</td><td style={{ ...S.td, fontSize: '0.83rem', color: 'var(--text-secondary)' }}>{e}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={m}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{m}</td><td style={S.td}>{d}</td><td style={{ ...S.td, color: '#4a9eed', fontSize: '0.85rem' }}>{v}</td><td style={{ ...S.td, color: '#4a9eed', fontSize: '0.85rem' }}>{dv}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={c}><td style={{ ...S.td, fontWeight: 600 }}>{c}</td><td style={{ ...S.td, fontSize: '0.85rem', color: '#4a9eed' }}>{vm}</td><td style={{ ...S.td, fontSize: '0.85rem', color: '#4a9eed' }}>{ct}</td><td style={{ ...S.td, fontSize: '0.85rem', color: '#4a9eed' }}>{fa}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={t}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{t}</td><td style={{ ...S.td, fontSize: '0.85rem' }}>{a}</td><td style={{ ...S.td, fontSize: '0.85rem', color: 'var(--text-secondary)' }}>{c}</td><td style={{ ...S.td, fontSize: '0.85rem', color: 'var(--text-secondary)' }}>{u}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={c}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{c}</td><td style={S.td}>{d}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
