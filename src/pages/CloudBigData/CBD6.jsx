...
const StreamingDiagram = () => (
  <div style={S.diagram}>
    ...
    <svg viewBox="0 0 580 150" style={{ maxWidth: '100%', height: 'auto' }}>
      <defs>
        <marker id="arr-st" markerWidth="6" markerHeight="6" refX="3" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#4a9eed" /></marker>
      </defs>
      {/* Source */}
      <rect x="10" y="35" width="90" height="80" rx="7" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" />
      <text x="55" y="58" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">Source</text>
      ...
      {/* Arrow */}
      <line x1="100" y1="75" x2="130" y2="75" stroke="#4a9eed" strokeWidth="2" markerEnd="url(#arr-st)" />
      {/* Unbounded Table */}
      <rect x="130" y="25" width="130" height="100" rx="7" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" />
      <text x="195" y="48" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">Unbounded Table</text>
      ...
      {/* Arrow */}
      <line x1="260" y1="75" x2="290" y2="75" stroke="#4a9eed" strokeWidth="2" markerEnd="url(#arr-st)" />
      {/* Query */}
      <rect x="290" y="35" width="120" height="80" rx="7" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" />
      <text x="350" y="58" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">Query</text>
      ...
      {/* Arrow */}
      <line x1="410" y1="75" x2="440" y2="75" stroke="#4a9eed" strokeWidth="2" markerEnd="url(#arr-st)" />
      {/* Sink */}
      <rect x="440" y="35" width="120" height="80" rx="7" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5" />
      <text x="500" y="58" textAnchor="middle" fill="#4a9eed" fontSize="10" fontWeight="700">Sink</text>
...
const LambdaKappaDiagram = () => (
  <div style={S.diagram}>
    ...
    <svg viewBox="0 0 600 280" style={{ maxWidth: '100%', height: 'auto' }}>
      <defs>
        <marker id="arr-lk" markerWidth="6" markerHeight="6" refX="3" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#4a9eed" /></marker>
        <marker id="arr-lk-r" markerWidth="6" markerHeight="6" refX="3" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#4a9eed" /></marker>
      </defs>

      {/* ===== LAMBDA (left) ===== */}
      <text x="145" y="16" textAnchor="middle" fill="var(--text-primary)" fontSize="11" fontWeight="700">Lambda Architecture</text>
      {/* Source */}
      <rect x="95" y="25" width="100" height="32" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="145" y="45" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Data Source</text>
      {/* arrows down to batch & speed */}
      <line x1="120" y1="57" x2="75" y2="85" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      <line x1="170" y1="57" x2="215" y2="85" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      {/* Batch layer */}
      <rect x="10" y="88" width="130" height="44" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="75" y="106" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Batch Layer</text>
      <text x="75" y="120" textAnchor="middle" fill="var(--text-secondary)" fontSize="7.5">recomputa tudo (Spark)</text>
      {/* Speed layer */}
      <rect x="150" y="88" width="130" height="44" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="215" y="106" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Speed Layer</text>
      <text x="215" y="120" textAnchor="middle" fill="var(--text-secondary)" fontSize="7.5">incremental (Spark/Flink)</text>
      {/* arrows to views */}
      <line x1="75" y1="132" x2="75" y2="158" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      <line x1="215" y1="132" x2="215" y2="158" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      {/* Views */}
      ...
      {/* arrows to serving */}
      <line x1="90" y1="193" x2="130" y2="220" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      <line x1="200" y1="193" x2="160" y2="220" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      {/* Serving layer */}
      <rect x="55" y="223" width="180" height="32" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="145" y="243" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Serving Layer (merge)</text>
      ...
      <rect x="380" y="25" width="150" height="32" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="455" y="40" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Kafka (log imutável)</text>
      <text x="455" y="52" textAnchor="middle" fill="var(--text-secondary)" fontSize="7.5">retenção longa / infinita</text>
      {/* arrow down */}
      <line x1="455" y1="57" x2="455" y2="98" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      {/* Stream processing */}
      <rect x="380" y="101" width="150" height="44" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="455" y="120" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Stream Processing</text>
      <text x="455" y="134" textAnchor="middle" fill="var(--text-secondary)" fontSize="7.5">Spark Structured Streaming</text>
      {/* arrow down */}
      <line x1="455" y1="145" x2="455" y2="186" stroke="#4a9eed" strokeWidth="1.5" markerEnd="url(#arr-lk)"/>
      {/* Serving layer */}
      <rect x="380" y="189" width="150" height="32" rx="6" fill="rgba(74,158,237,0.10)" stroke="#4a9eed" strokeWidth="1.5"/>
      <text x="455" y="209" textAnchor="middle" fill="#4a9eed" fontSize="9" fontWeight="700">Serving Layer</text>
      {/* reprocessing loop */}
      <path d="M 380,118 C 350,118 350,30 378,40" fill="none" stroke="#4a9eed" strokeWidth="1.5" strokeDasharray="3,2" markerEnd="url(#arr-lk-r)"/>
      <text x="358" y="70" textAnchor="middle" fill="#4a9eed" fontSize="7.5" transform="rotate(-90,358,80)">novo consumer group</text>
...
const WindowExplorer = () => {
  ...
  const windows = [
    {
      name: 'Tumbling Window', color: '#4a9eed',
    ...
    {
      name: 'Sliding Window', color: '#4a9eed',
    ...
    {
      name: 'Session Window', color: '#4a9eed',
      ...
      <div style={S.page}>
        ...
        <div style={S.section}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
            <div style={{ background: 'rgba(74,158,237,0.06)', border: '1px solid rgba(74,158,237,0.25)', borderRadius: 8, padding: '1rem' }}>
              <div style={{ fontWeight: 700, color: '#4a9eed', marginBottom: '0.5rem' }}>Batch — Quando usar</div>
            ...
            <div style={{ background: 'rgba(74,158,237,0.06)', border: '1px solid rgba(74,158,237,0.25)', borderRadius: 8, padding: '1rem' }}>
              <div style={{ fontWeight: 700, color: '#4a9eed', marginBottom: '0.5rem' }}>Streaming — Quando usar</div>
              <ul style={{ margin: 0, paddingLeft: '1.2rem', fontSize: '0.84rem', color: 'var(--text-secondary)', lineHeight: 1.9 }}>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={c}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{c}</td><td style={S.td}>{d}</td><td style={{ ...S.td, fontSize: '0.83rem', color: 'var(--text-secondary)', fontStyle: 'italic' }}>{a}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
        ...
        <div style={S.section}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
            <div style={{ background: 'rgba(74,158,237,0.10)', border: '1px solid rgba(74,158,237,0.10)', borderRadius: 8, padding: '1rem' }}>
              <div style={{ fontWeight: 700, color: '#4a9eed', marginBottom: '0.5rem' }}>Processing Time (problemático)</div>
              ...
              <p style={{ fontSize: '0.82rem', color: '#4a9eed' }}>Exemplo: sensor envia dados cada 5 minutos mas a rede falha por 20 minutos — os eventos chegam ao Spark em batch e são incorrectamente atribuídos ao momento de chegada, não ao momento de medição.</p>
            </div>
            <div style={{ background: 'rgba(74,158,237,0.10)', border: '1px solid rgba(74,158,237,0.10)', borderRadius: 8, padding: '1rem' }}>
              <div style={{ fontWeight: 700, color: '#4a9eed', marginBottom: '0.5rem' }}>Event Time (correcto)</div>
              ...
              <p style={{ fontSize: '0.82rem', color: '#4a9eed' }}>O mesmo sensor: os dados são correctamente agregados pela hora de medição, independentemente de quando chegaram ao Spark. A janela só fecha quando se sabe que não chegam mais eventos tardios.</p>
            </div>
          </div>
        ...
        <div style={S.section}>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={m}><td style={{ ...S.td, fontWeight: 600, color: '#4a9eed' }}>{m}</td><td style={S.td}>{o}</td><td style={S.td}>{u}</td><td style={{ ...S.td, fontSize: '0.83rem', color: 'var(--text-secondary)' }}>{c}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
            {[
              { n: 'At-Most-Once', c: '#4a9eed', desc: 'Cada evento é processado zero ou uma vez. Se o executor falha após ler mas antes de persistir, o evento é perdido. Nunca duplica, mas pode perder dados.', uso: 'Métricas onde perder alguns pontos é aceitável. Logging de alta frequência.' },
              { n: 'At-Least-Once', c: '#4a9eed', desc: 'Cada evento é processado uma ou mais vezes. Se o executor falha, o evento é reprocessado do offset guardado. Garante que não se perde eventos, mas pode duplicar.', uso: 'Pipelines onde deduplicação downstream é possível. Mais fácil de implementar.' },
              { n: 'Exactly-Once', c: '#4a9eed', desc: 'Cada evento é processado exactamente uma vez, mesmo com falhas. Requer sinks idempotentes ou transacções distribuídas. Spark Structured Streaming + Delta Lake garante isto nativamente.', uso: 'Sistemas financeiros, billing, qualquer situação onde duplicados causam danos.' },
            ].map(({ n, c, desc, uso }) => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            ...
            <div style={{ background: 'var(--bg-secondary)', border: '1px solid var(--card-border)', borderRadius: 8, padding: '1rem' }}>
              ...
              <div style={{ fontSize: '0.8rem', color: '#4a9eed', fontWeight: 600 }}>Tendência actual: Kappa com Spark Structured Streaming + Delta Lake. Spark Structured Streaming pode fazer backfill batch e streaming com o mesmo código.</div>
            </div>
          </div>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={c}><td style={{ ...S.td, fontWeight: 600 }}>{c}</td><td style={{ ...S.td, fontSize: '0.85rem', color: 'var(--text-secondary)' }}>{l}</td><td style={{ ...S.td, fontSize: '0.85rem', color: '#4a9eed' }}>{k}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
