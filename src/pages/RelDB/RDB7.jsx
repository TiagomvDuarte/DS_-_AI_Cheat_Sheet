...
export default function RDB7() {
  return (
    <div style={S.page}>
      ...
      <p style={S.lead}>
        As transacções são o mecanismo que garante integridade dos dados em cenários concorrentes e perante
        falhas. Neste módulo analisamos as propriedades ACID, os níveis de isolamento, os mecanismos de
        concorrência e recovery, e terminamos com uma comparação entre RDBMS e sistemas NoSQL.
      </p>
      ...
      <div style={S.section}>
        ...
        <div style={{ ...S.highlight, borderRadius: 10 }}>
          <ul style={{ margin: '0 0 0 1.2rem', lineHeight: 2, color: 'var(--text-primary)', fontSize: '0.95rem' }}>
            <li>ACID garante Atomicidade, Consistência, Isolamento e Durabilidade — a base da integridade transaccional.</li>
            <li>Os quatro níveis de isolamento trocam consistência por performance; READ COMMITTED é o padrão na maioria dos RDBMS.</li>
            <li>Locks controlam acesso concorrente; MVCC permite leituras não bloqueantes mantendo snapshots por transacção.</li>
            <li>WAL garante durabilidade e recovery após falha — checkpoints limitam o tempo de recovery; redo/undo logs restauram o estado consistente.</li>
            <li>NoSQL adopta BASE e escala horizontalmente ao custo de consistência forte; o teorema CAP enquadra as trocas inevitáveis em sistemas distribuídos.</li>
          </ul>
        </div>
      </div>
    </div>
