...
export const modules = [
  { id: 'par1', num: '01', title: 'Fundamentos de Computação Paralela', subtitle: 'Amdahl, Gustafson, Roofline Model, Flynn Taxonomy e Speedup', topics: ['Lei de Amdahl — limite teórico do speedup', 'Lei de Gustafson — weak scaling', 'Roofline Model — compute vs. memory bound', 'Taxonomia de Flynn: SISD, SIMD, MISD, MIMD'], path: '/parallel/lecture1', color: '#4a9eed' },
  { id: 'par2', num: '02', title: 'Arquitecturas de Memória & Cache', subtitle: 'Hierarquia de Cache, NUMA, Coerência e False Sharing', topics: ['Hierarquia de memória: L1/L2/L3/RAM', 'Protocolo MESI — coerência de cache', 'NUMA — Non-Uniform Memory Access', 'False sharing e padding de cache lines'], path: '/parallel/lecture2', color: '#4a9eed' },
  { id: 'par3', num: '03', title: 'Threads, Processos & Python Paralelo', subtitle: 'GIL, threading, multiprocessing, asyncio e Sincronização', topics: ['Python GIL — causa e consequências', 'threading vs multiprocessing — quando usar', 'asyncio — concorrência I/O-bound', 'Race conditions, locks, semáforos, deadlock'], path: '/parallel/lecture3', color: '#4a9eed' },
  { id: 'par4', num: '04', title: 'OpenMP', subtitle: 'Fork-Join, Pragmas, Reduction, Tasks e Scheduling', topics: ['Modelo fork-join — regiões paralelas', '#pragma omp parallel for, sections, tasks', 'Reduction clause — somas e produtos paralelos', 'Scheduling: static, dynamic, guided'], path: '/parallel/lecture4', color: '#4a9eed' },
  { id: 'par5', num: '05', title: 'MPI — Message Passing Interface', subtitle: 'Memória Distribuída, Send/Recv, Colectivas e Topologias', topics: ['MPI_Send/Recv — comunicação ponto-a-ponto', 'MPI_Bcast, MPI_Scatter, MPI_Gather, MPI_Reduce', 'Topologias virtuais — cartesianas e grafos', 'MPI+OpenMP — paralelismo híbrido'], path: '/parallel/lecture5', color: '#4a9eed' },
  { id: 'par6', num: '06', title: 'GPU Computing & CUDA', subtitle: 'SIMT, Kernels, Hierarquia de Memória e Optimização', topics: ['CPU vs GPU — throughput vs latency', 'CUDA: grids, blocos e threads', 'Memória: global, shared, registers, constant', 'Warp divergence, memory coalescing, occupancy'], path: '/parallel/lecture6', color: '#4a9eed' },
  { id: 'par7', num: '07', title: 'Vectorização & Numba', subtitle: 'SIMD, AVX, NumPy Vectorization, Numba JIT e CuPy', topics: ['SIMD — AVX2/AVX-512, instrução por vector', 'NumPy vectorization vs. Python loops', 'Numba @jit, @njit e @cuda.jit', 'CuPy — NumPy na GPU'], path: '/parallel/lecture7', color: '#4a9eed' },
  { id: 'par8', num: '08', title: 'Profiling & Frameworks Modernos', subtitle: 'Roofline em Prática, perf, nsight, Dask, Ray e Spark', topics: ['Profiling: cProfile, line_profiler, perf', 'NVIDIA Nsight — profiling de kernels CUDA', 'Dask, Ray e Spark — guia de decisão', 'Bottleneck identification e tuning workflow'], path: '/parallel/lecture8', color: '#4a9eed' },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1rem 4rem' }}>
      ...
      <div style={{ marginBottom: '2.5rem' }}>
        <div style={{ display: 'inline-block', background: 'transparent', color: '#4a9eed', border: '1.5px solid #4a9eed', fontSize: '0.75rem', fontWeight: 700, padding: '0.25rem 0.75rem', borderRadius: 20, marginBottom: '0.75rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>PARALLEL & HPC</div>
