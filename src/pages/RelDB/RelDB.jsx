...
export const modules = [
  { id: 'rdb1', num: '01', title: 'Introdução e Normalização',              subtitle: 'DBMS, Modelo Relacional, Dependências Funcionais e Formas Normais',  topics: ['O que é uma Base de Dados e DBMS', 'Modelo relacional — tabelas, tuplos, atributos', 'Dependências funcionais (1NF, 2NF, 3NF, BCNF)', 'Decomposição sem perda e preservação de dependências'], path: '/reldb/lecture1', color: '#4a9eed' },
  { id: 'rdb2', num: '02', title: 'Arquitectura DBMS e Modelo ER',          subtitle: 'Componentes do DBMS, Entidades, Relações e Diagramas ER',           topics: ['Connection Manager, Query Parser, Optimizer', 'DDL e DML Compilers', 'Entidades, atributos e relações', 'Cardinalidade: 1:1, 1:N, M:N e participação'], path: '/reldb/lecture2', color: '#4a9eed' },
  { id: 'rdb3', num: '03', title: 'SQL — Fundamentos',                          subtitle: 'DDL, CREATE TABLE, Tipos de Dados, Constraints e SELECT Básico',     topics: ['CREATE/DROP DATABASE e TABLE', 'Tipos de dados: INT, VARCHAR, DATE, FLOAT', 'PRIMARY KEY, FOREIGN KEY, NOT NULL, DEFAULT', 'SELECT, WHERE, ORDER BY, LIMIT'], path: '/reldb/lecture3', color: '#4a9eed' },
  { id: 'rdb4', num: '04', title: 'SQL — Análise e Optimização',                          subtitle: 'CRUD Completo, JOINs, Subqueries e GROUP BY',                        topics: ['INSERT, UPDATE, DELETE — sintaxe e cuidados', 'INNER JOIN, LEFT/RIGHT JOIN, FULL JOIN', 'Subqueries correlacionadas e não correlacionadas', 'GROUP BY, HAVING, funções de janela (OVER, PARTITION BY)'], path: '/reldb/lecture4', color: '#4a9eed' },
  { id: 'rdb5', num: '05', title: 'Funções Agregadas, Views e Triggers',    subtitle: 'AVG/COUNT/SUM, GROUP BY/HAVING, Views e Automação',                 topics: ['AVG, MAX, MIN, COUNT, SUM, STDEV', 'GROUP BY e filtragem com HAVING', 'CREATE VIEW — views simples e complexas', 'BEFORE/AFTER TRIGGERS — automação de lógica de negócio'], path: '/reldb/lecture5', color: '#4a9eed' },
  { id: 'rdb6', num: '06', title: 'Otimização de Queries',                  subtitle: 'EXPLAIN, Planos de Execução, Índices e Query Tuning',                topics: ['Query Execution Plan (QEP) e EXPLAIN', 'B-Tree, Hash e Covering Index', 'Quando e como criar índices', 'Reescrita de queries — optimização manual'], path: '/reldb/lecture6', color: '#4a9eed' },
  { id: 'rdb7', num: '07', title: 'ACID, Transações e NoSQL',               subtitle: 'Propriedades ACID, Níveis de Isolamento e CAP Theorem',              topics: ['BEGIN, COMMIT, ROLLBACK e SAVEPOINT', 'ACID: Atomicidade, Consistência, Isolamento, Durabilidade', 'Níveis de isolamento: Read Uncommitted → Serializable', 'CAP Theorem — transição para NoSQL'], path: '/reldb/lecture7', color: '#4a9eed' },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1rem 4rem' }}>
      ...
      <div style={{ marginBottom: '2.5rem' }}>
        <div style={{ display: 'inline-block', background: 'transparent', color: '#4a9eed', border: '1.5px solid #4a9eed', fontSize: '0.75rem', fontWeight: 700, padding: '0.25rem 0.75rem', borderRadius: 20, marginBottom: '0.75rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>RELATIONAL DATABASES</div>
